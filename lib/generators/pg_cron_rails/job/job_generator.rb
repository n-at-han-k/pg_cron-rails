...
require "generators/pg_cron_rails/version_helper"
require "generators/pg_cron_rails/migration_helper"
require "generators/pg_cron_rails/name_helper"

module PgCronRails
  module Generators
    # Generates a cron job definition and its migration.
    #
    #   rails generate pg_cron_rails:job drain_juicefs_events
    #
    ...
    class JobGenerator < Rails::Generators::NamedBase
      ...
      no_tasks do
        ...
        def formatted_name
          PgCronRails::Generators::NameHelper.format_for_migration(singular_name)
        end
      end
      ...
      def version_helper
        @_version_helper ||= PgCronRails::Generators::VersionHelper.new(
          file_name: file_name,
      ...
      def migration_helper
        @_migration_helper ||= PgCronRails::Generators::MigrationHelper.new(options)
      end
